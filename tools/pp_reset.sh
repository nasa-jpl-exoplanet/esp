...
myself=${DAWGIE_SSL_PEM_MYSELF:-/proj/sdp/${EXCALIBUR_USER:-${USER:-nouser}}/certs/${USER}.ca.signed.pem}

curl -XPOST --cert ${myself} "https://${EXCALIBUR_HOST:-localhost}:8185/api/cmd/reset?archive=${DAWGIE_ARCHIVE:-false}"
