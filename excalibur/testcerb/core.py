...
TestcerbParams = namedtuple(
    'testcerb_params_from_runtime',
    [
        'tier',
        'SNRfactor',
        'randomSeed',
...
#        )
        ariel_instrument = load_ariel_instrument('HD 209458 b', 2)
        ...
        if ariel_instrument:
            ...
            if HoverRmax > 666:
                ...
                for atmosModel in atmosModels:
                    ...
                    print('model_params in testcerb:',model_params)
                    ...
                    # plot_dir = (
                    #     excalibur.context['data_dir'] + '/testcerb/savedplots'
                    # )
                    # if not os.path.exists(plot_dir):
                    #    os.mkdir(plot_dir)
                    # plt.savefig(plot_dir +
                    #             '/testcerb_' + atmosModel + 'Atmos_' +
                    #             target + '_' + planet_letter + '.png')

                    # REDUNDANT SAVE - above saves to disk; below saves as state vector
                    # plt.title('Testcerb : '+target+' '+planet_letter, fontsize=16)
