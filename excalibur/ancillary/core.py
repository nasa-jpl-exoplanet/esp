...
def getestimators():
    ...
    pl_estimators = [
        ...
        PlEstimator(
            name='metallicity_chachan',
            units='logarithmic',
            descr='metallicity',
            method=ancestor.pl_metals_chachan,
            ref='Chachan et al 2025',
        ),
        PlEstimator(
            name='metallicity_thorngren',
            units='logarithmic',
            descr='metallicity',
            method=ancestor.pl_metals_thorngren,
        ...
        PlEstimator(
            ...
            method=ancestor.pl_mmw_chachan,
        ...
        PlEstimator(
            ...
            units='AMU',
            descr='mean molecular weight (CBE)',
            method=ancestor.pl_mmw_thorngren,
            ref='CEA (T=1000K;C/O=solar)',
        ),
        PlEstimator(
            name='mmw_min',
