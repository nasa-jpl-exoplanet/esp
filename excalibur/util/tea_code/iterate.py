...
from excalibur.util.tea_code import lagrange
from excalibur.util.tea_code import lambdacorr
...
def iterate(
    ...
    while it_num < maxiter:
        ...
        lc_data = lagrange.lagrange(it_num, verb, lc_data, info)
        ...
        if np.any(lc_data[1] < 0):
            ...
            lc_data = lambdacorr.lambdacorr(it_num, verb, lc_data, info)
