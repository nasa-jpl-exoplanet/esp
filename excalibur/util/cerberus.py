...
def calcTEA(
    ...
    # scale abundances for metallicity, C/O, N/O, S/O
    def _scale_abund(
        ...
        """
        Apply metallicity & C/O, N/O, S/O tweaks while preserving mass balance.
    ...
    abund = _scale_abund(
        {k: solar[k] for k in needed_elem}, metallicity, C_O, N_O, S_O
    )
    ...
    # print('mixratio H2O',mixratio['H2O'])
